        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg space-y-2">
              <p className="text-gray-900 font-semibold text-lg">Union Awas Happy Holiday Guest House</p>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Union Awas Happy Holiday Guest House operates in compliance with all applicable Indian laws and regulations, including the Hotel and Lodging House Act and local municipal regulations of Bhopal, Madhya Pradesh.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              This website serves as the official online booking platform for Union Awas Happy Holiday Guest House. The website provides information about our accommodation services, facilities, pricing, and enables online reservations.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              are the exclusive property of Union Awas Happy Holiday Guest House or its licensors and are protected by Indian and international copyright laws, trademark laws, and other intellectual property rights. Unauthorized use, reproduction, or distribution is strictly prohibited and may result in legal action.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              © 2025 Union Awas Happy Holiday Guest House. All rights reserved. No part of this website may be reproduced, distributed, or transmitted in any form or by any means without the prior written permission of Union Awas Happy Holiday Guest House.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              To the maximum extent permitted by Indian law, Union Awas Happy Holiday Guest House shall not be liable for any direct, indirect, incidental, consequential, or punitive damages arising from your use or inability to use this website, including but not limited to damages for loss of profits, data, or other intangible losses.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <li>Respect the intellectual property rights of Union Awas Happy Holiday Guest House</li>
            </ul>
          </section>
