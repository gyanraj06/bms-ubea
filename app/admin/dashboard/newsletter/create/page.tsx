        ...
        try {
            ...
            const response = await fetch("/api/admin/newsletter", {
                ...
                body: JSON.stringify({
                    ...formData,
                    attachments,
                    // Keep file_url for backward compatibility if needed, or just use first attachment
                    file_url: attachments.length > 0 ? attachments[0].url : "",
                }),
            });
            ...
            if (response.ok) {
                ...
                toast.error(data.error || "Failed to create newsletter");
            }
        } catch (error: any) {
        ...
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600">Add a new report, news, or broadcast</p>
                </div>
            </div>
