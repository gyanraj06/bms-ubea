        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <li><strong>"Property"</strong> refers to Union Awas Happy Holiday Guest House located in Bhopal, Madhya Pradesh</li>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              All content on this website, including text, graphics, logos, images, and software, is the property of Union Awas Happy Holiday Guest House or its licensors and is protected by Indian copyright laws and international intellectual property treaties. Unauthorized use is prohibited.
            </p>
          </section>
