...
const getPropertySettings = async (): Promise<PropertySettings> => {
  try {
    ...
    return {
      property_name: data.property_name || 'Happy Holidays',
...
export async function sendBookingConfirmationEmail(bookingData: BookingEmailData) {
  try {
    ...
    const senderName = process.env.ZEPTO_MAIL_SENDER_NAME || 'Happy Holidays';
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p class="p">
          Thank you for choosing Happy Holidays! Your booking has been
      ...
      <!-- Footer -->
      <div class="footer">
        <p>&copy; Happy Holidays. All rights reserved.</p>
